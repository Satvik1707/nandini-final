<template>
  <header>
    <g-link class="site-logomark" to="/"> 
      ...
      <span class="nav-title">Nandini Gulati</span>
    </g-link>
    <nav>
      ...
      <div :class="{ 'secondary-nav': true, open }">
        ...
        <g-link :class="{ active: ($page == '/collections') ? true : false }" to="/collections">My Works</g-link>
      ...
      <a class="contact" href="mailto:nandinigulati2001@gmail.com">Contact</a>
    </nav>
  </header>
</template>
